...
class pg_bulkload(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.install('postgresql-server-dev-9.3')
		shutit.install('libpam0g-dev')
		shutit.install('libedit-dev')
		shutit.send('git clone --depth=1 https://github.com/ossc-db/pg_bulkload.git')
		shutit.send('cd pg_bulkload')
		shutit.send('make')
		shutit.send('make install')
		shutit.send('cd')
		shutit.send('rm -rf pg_bulkload')
		return True
